Rails.application.routes.draw do  
  ...
  get("/roll/1/6", { :controller => "dice", :action => "roll1"})
  get("/roll/2/6", { :controller => "dice", :action => "roll2"})
  get("/roll/3/6", { :controller => "dice", :action => "roll3"})
  get("/roll/4/6", { :controller => "dice", :action => "roll4"})
  get("/roll/5/6", { :controller => "dice", :action => "roll5"})
  get("/roll/6/6", { :controller => "dice", :action => "roll6"})
